<template>
    <section>
        ...
        {{ exerciseIndex }}
        <b-col sm="3">
            <b-card-title><b-form-input type="text" v-model="storeInfo.exerciseName"></b-form-input></b-card-title><button v-if="exerciseNameP !== storeInfo.exerciseName && exerciseIndex !== ''" @click="updateExerciseName">Save</button>
        </b-col>
    ...
    export default {
        ...
        methods: {
            ...
            deleteExercise() {
                ...
                if(this.exerciseIndex == undefined){
                    axios.request({
                    url: `${process.env.VUE_APP_BASE_DOMAIN}/api/exercises`,
                    method: 'DELETE',
                    headers:{
